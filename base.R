...
#' 
#' @importFrom ggplot2 ggplot aes geom_bar geom_label coord_polar theme_minimal scale_fill_manual labs theme element_blank element_text unit
#' @importFrom dplyr rename group_by summarise arrange slice pull filter bind_rows mutate across
...
#' 
#' @importFrom ggplot2 ggplot aes geom_sf scale_fill_identity theme_dark coord_sf labs theme element_rect element_line element_text
...
#' 
#' @importFrom dplyr select_if drop_na
...
#' 
#' @importFrom dplyr select_if select matches
#' @importFrom tidyr drop_na gather
#' @importFrom ggplot2 ggplot aes geom_boxplot geom_bar geom_label facet_wrap theme_classic theme labs coord_flip
#' 
...
#' 
#' @importFrom dplyr mutate_if select_if select
